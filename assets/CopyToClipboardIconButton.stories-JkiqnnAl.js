import{j as V}from"./index-BAINcZ39.js";import"./index-DQLiH3RP.js";import"./FormFactory-EE-hfXZ2.js";import{a as j}from"./Map-vmRLmvhD.js";import{P as H}from"./Pets-8M9RJObW.js";import"./index-CJPVTaBz.js";const Y={title:"Clipboard/CopyToClipboardIconButton",component:j,parameters:{layout:"centered"},argTypes:{size:{control:"select",options:["small","medium","large"]},fontSize:{control:"select",options:["small","medium","large"]}},args:{value:"Hello, world!",hoverMessage:"Copy to clipboard",progressMessage:"Copying...",successMessage:"Copied!"}},e={args:{size:"small",fontSize:"small"}},r={args:{size:"medium",fontSize:"medium"}},s={args:{size:"large",fontSize:"large"}},o={args:{value:void 0}},a={args:{children:V.jsx(H,{})}},t={args:{hoverMessage:"You should copy this!"}},n={args:{value:async()=>new Promise(b=>{setTimeout(()=>{b("This took a while to generate!")},2e3)})}};var c,m,i;e.parameters={...e.parameters,docs:{...(c=e.parameters)==null?void 0:c.docs,source:{originalSource:`{
  args: {
    size: 'small',
    fontSize: 'small'
  }
