import{j as r}from"./index-BAINcZ39.js";import"./index-DQLiH3RP.js";import{c as n,e as Y,B as Z}from"./FormFactory--pUYyBn8.js";import{I as $}from"./Map-UCBDsxim.js";import{T as ee}from"./ThemeProvider-DWXpeFYp.js";import"./index-CJPVTaBz.js";const oe=n(r.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2M9 17H7v-5h2zm4 0h-2v-3h2zm0-5h-2v-2h2zm4 5h-2V7h2z"})),re=n(r.jsx("path",{d:"m14 12-2 2-2-2 2-2zm-2-6 2.12 2.12 2.5-2.5L12 1 7.38 5.62l2.5 2.5zm-6 6 2.12-2.12-2.5-2.5L1 12l4.62 4.62 2.5-2.5zm12 0-2.12 2.12 2.5 2.5L23 12l-4.62-4.62-2.5 2.5zm-6 6-2.12-2.12-2.5 2.5L12 23l4.62-4.62-2.5-2.5z"})),ae=n(r.jsx("path",{d:"M21.5 14.98c-.02 0-.03 0-.05.01C21.2 13.3 19.76 12 18 12c-1.4 0-2.6.83-3.16 2.02C13.26 14.1 12 15.4 12 17c0 1.66 1.34 3 3 3l6.5-.02c1.38 0 2.5-1.12 2.5-2.5s-1.12-2.5-2.5-2.5M10 4.26v2.09C7.67 7.18 6 9.39 6 12c0 1.77.78 3.34 2 4.44V14h2v6H4v-2h2.73C5.06 16.54 4 14.4 4 12c0-3.73 2.55-6.85 6-7.74M20 6h-2.73c1.43 1.26 2.41 3.01 2.66 5h-2.02c-.23-1.36-.93-2.55-1.91-3.44V10h-2V4h6z"})),ne=n(r.jsx("path",{d:"M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2m-8 14H7v-4h4zm0-6H7V7h4zm6 6h-4v-4h4zm0-6h-4V7h4z"})),te=n(r.jsx("path",{d:"M2 20h20v-4H2zm2-3h2v2H4zM2 4v4h20V4zm4 3H4V5h2zm-4 7h20v-4H2zm2-3h2v2H4z"})),ce=Y(),ue={title:"IconList/IconList",component:$,decorators:[X=>r.jsx(ee,{theme:ce,children:r.jsx(Z,{sx:{padding:2,maxWidth:500},children:r.jsx(X,{})})})],parameters:{layout:"centered"},argTypes:{title:{control:"text",description:"Title of the icon list"},maxWidth:{control:"number",description:"Maximum width of the icon list"},maxHeight:{control:"number",description:"Maximum height of the icon list"},theme:{control:"object",description:"Theme configuration for colors, elevation, etc.",table:{type:{summary:"icon list Theme",detail:`{
  header?: {
...
}`,...(b=(C=t.parameters)==null?void 0:C.docs)==null?void 0:b.source}}};var v,S,A;c.parameters={...c.parameters,docs:{...(v=c.parameters)==null?void 0:v.docs,source:{originalSource:`{
  args: {
    sources: [],
    title: 'No Data Available'
  }
}`,...(A=(S=c.parameters)==null?void 0:S.docs)==null?void 0:A.source}}};var k,x,L;s.parameters={...s.parameters,docs:{...(k=s.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(H=(z=l.parameters)==null?void 0:z.docs)==null?void 0:H.source}}};var I,M,D;d.parameters={...d.parameters,docs:{...(I=d.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    sources: createAtlasColoredsources(),
    title: 'Minimal Theme',
    theme: {
...
}`,...(D=(M=d.parameters)==null?void 0:M.docs)==null?void 0:D.source}}};var R,E,_;m.parameters={...m.parameters,docs:{...(R=m.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
    sources: [{
      id: 'failed-db',
